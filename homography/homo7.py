...
cap = cv2.VideoCapture('beachVolleyball7.mov')
...
p0 = np.float32(np.array([[[188,314]],[[18,322]],[[214,239]],[[132,336]],[[44,176]],[[116,177]],[[83,235]],[[41,347]]]))
print p0
mask = np.zeros_like(old_frame)

cutp = np.float32(np.array([[[458,329]]]))
pano = np.float32(np.array([[[458,329]],[[403,226]],[[91,235]],[[90,343]]]))
orin = np.float32(np.array([[[458,329]],[[403,226]],[[91,235]],[[90,343]]]))
...
video = cv2.VideoWriter('panoramadiagonal7.mov',fourcc,fps=59,frameSize=(width,height),isColor=1)
for warp in results:
    video.write(warp)
