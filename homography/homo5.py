...
p0 = np.float32(np.array([[[189,158]],[[456,164]],[[414,194]],[[227,180]],[[198,182]],[[447,178]],[[215,155]],[[495,164]]]))
print p0
mask = np.zeros_like(old_frame)

cutp = np.float32(np.array([[[103,257]]]))
pano = np.float32(np.array([[[103,257]],[[568,252]],[[426,166]],[[209,164]]]))
orin = np.float32(np.array([[[103,257]],[[568,252]],[[426,166]],[[209,164]]]))
...
video = cv2.VideoWriter('panoramadiagonal5.mov',fourcc,fps=59,frameSize=(width,height),isColor=1)
for warp in results:
    video.write(warp)
